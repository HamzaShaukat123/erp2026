<?php
    ...
    Route::middleware(['checkPermission:view'])->group(function () {
        ...
        Route::get('/coa/show/{ac_code}', [App\Http\Controllers\COAController::class, 'show'])->name('show-acc');
    ...
    Route::middleware(['auth'])->group(function () {
        ...
        // Petty Cash Tab
        Route::get('/dashboard-tabs/petty-cash', [App\Http\Controllers\DashboardPettyCashTabController::class, 'PettyCash'])->name('PettyCash');
