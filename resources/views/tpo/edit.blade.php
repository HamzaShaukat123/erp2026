...
<script>
	...
	function addNewRow(){
		...
		if(latestValue!=""){
			...
			cell4.innerHTML  = '<input type="number" class="form-control" onchange="CalculateRowWeight('+index+')" id="pur2_qty2_'+index+'" value="0" name="pur2_qty2[]" step="any" required>';
			...
			cell8.innerHTML  = '<input type="number" class="form-control" id="pur2_qty'+index+'" value="0" step="any" required disabled><input type="hidden" class="form-control" name="pur2_qty[]" id="pur2_qty_show'+index+'" value="0" step="any" required>';
